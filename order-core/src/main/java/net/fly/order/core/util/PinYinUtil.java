...
public class PinYinUtil {
  ...
  public static void main(String[] args) {
    String pinYin = getAllPinyin("测试信息");
    String firstPinYin = getFirstPinYin("测试信息");
    System.out.println("测试信息全拼："+pinYin);
    System.out.println("测试信息首字母："+firstPinYin);
